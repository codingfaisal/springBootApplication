...
public class searchRepositoryImplementation implements searchRepository{
    ...
    @Override
    public List<jobProfile> findByText(String text) {

        final List<jobProfile> posts = new ArrayList<>();
        ...
        result.forEach(doc -> posts.add(converter.read(jobProfile.class,doc)));
